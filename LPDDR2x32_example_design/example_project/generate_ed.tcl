...
lappend arg_list "--report-file=csv:LPDDR2x32_example.csv"
lappend arg_list "--report-file=qip:LPDDR2x32_example.qip"
lappend arg_list "--output-name=LPDDR2x32_example"
